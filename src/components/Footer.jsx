...
export default function Footer() {
  ...
  useEffect(() => {
    const fetchDepts = async () => {
      try {
        const q = query(collection(db, "departments"), orderBy("created_at", "desc"), limit(4));
  ...
  return (
    <>
      <style>{`
        .ft { background:#0f1923; color:#fff; padding:48px 60px 0; }
        .ft-container { display:grid; grid-template-columns:repeat(4,1fr); gap:32px; max-width:1200px; margin:0 auto; }
        .ft-brand-row { display:flex; align-items:center; gap:10px; margin-bottom:14px; }
        .ft-logo-icon { width:36px; height:36px; border:2px solid #e05c5c; border-radius:8px; display:flex; align-items:center; justify-content:center; flex-shrink:0; }
        .ft-brand-name { font-size:14px; font-weight:700; color:#fff; margin:0; font-family:'Poppins',sans-serif; line-height:1.3; }
        .ft-brand-desc { color:#aaa; font-size:13px; line-height:1.7; margin:0 0 18px; font-family:'Poppins',sans-serif; }
        .ft-social-row { display:flex; gap:10px; }
        .ft-social-icon { width:36px; height:36px; display:flex; align-items:center; justify-content:center; background:rgba(255,255,255,0.1); border-radius:50%; transition:background 0.2s; text-decoration:none; flex-shrink:0; }
        .ft-col-title { font-size:13px; font-weight:700; color:#fff; margin:0 0 16px; font-family:'Poppins',sans-serif; text-transform:uppercase; letter-spacing:1px; }
        .ft-link { color:#aaa; font-size:13px; cursor:pointer; margin:0 0 10px; transition:color 0.2s; display:block; font-family:'Poppins',sans-serif; }
      ...
      <footer className="ft">
        <div className="ft-container">
          ...
          <div>
            ...
            <p className="ft-brand-desc">Providing quality healthcare services with compassion and expertise.</p>
            <div className="ft-social-row">
              ...
              <a href="https://www.instagram.com" target="_blank" rel="noopener noreferrer" className="ft-social-icon"
                ...
                onMouseLeave={(e) => e.currentTarget.style.background="rgba(255,255,255,0.1)"}>
                <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="white" strokeWidth="2"><rect x="2" y="2" width="20" height="20" rx="5"/><circle cx="12" cy="12" r="4"/><circle cx="17.5" cy="6.5" r="0.5" fill="white" stroke="none"/></svg>
              </a>
            </div>
          </div>
          ...
          <div>
            ...
            <div className="ft-contact-row">
              <svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="#e05c5c" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" style={{flexShrink:0,marginTop:1}}><path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07A19.5 19.5 0 0 1 4.69 12 19.79 19.79 0 0 1 1.65 3.44 2 2 0 0 1 3.62 1h3a2 2 0 0 1 2 1.72c.127.96.361 1.903.7 2.81a2 2 0 0 1-.45 2.11L7.91 8.64a16 16 0 0 0 6 6l.96-.96a2 2 0 0 1 2.11-.45c.907.339 1.85.573 2.81.7A2 2 0 0 1 22 16.92z"/></svg>
              <p className="ft-contact-text">+971 (0) 4379 3562</p>
            </div>
            <div className="ft-contact-row">
              <svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="#e05c5c" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" style={{flexShrink:0,marginTop:1}}><path d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z"/><polyline points="22,6 12,13 2,6"/></svg>
              <p className="ft-contact-text">smart@smcare.ae</p>
            </div>
            <div className="ft-contact-row">
              <svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="#e05c5c" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" style={{flexShrink:0,marginTop:1}}><path d="M21 10c0 7-9 13-9 13s-9-6-9-13a9 9 0 0 1 18 0z"/><circle cx="12" cy="10" r="3"/></svg>
